...
// Định nghĩa kiểu dữ liệu cho một bản ghi đánh giá
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {assessments.length === 0 && !error ? (
          <div className="text-center text-gray-600">
            ...
            <a href="/" className="mt-4 inline-block rounded bg-blue-600 px-4 py-2 font-bold text-white hover:bg-blue-700">
